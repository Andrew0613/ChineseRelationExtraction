...
def analysis(dir,exp_name='dropout'):
    ...
    for path in paths:
        ...
        name = path
        dic = {'name':name,'acc':acc,'train_acc':train_acc,'time_list':time,'time_total':time_total,'loss':loss}
        dics.append(dic)
...
if __name__ == "__main__":
    result_path = 'analysis_for_results'
    # analysis(result_path,exp_name=None)
    analysis(result_path,exp_name='head')
    analysis(result_path,exp_name='hidden')